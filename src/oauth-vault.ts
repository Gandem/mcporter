 ...
 * backend (warning if one was requested). Keep the override in module state rather than process.env:
 * generated keep-alive definitions inherit that environment, and changing it would split their
 * daemon connection identity from an equivalent ordinary CLI definition.
 */
